...
public class SerializeAndDeserializeBinaryTree2 {
    ...
    public TreeNode buildTree(List<String> list) {
        ...
        TreeNode tree = new TreeNode(Integer.valueOf(cur));
        tree.left = buildTree(list);
        tree.right = buildTree(list);;
        return tree;
    }
    ...
    public static void main(String[] args) {
        SerializeAndDeserializeBinaryTree2 serializeAndDeserializeBinaryTree = new SerializeAndDeserializeBinaryTree2();
